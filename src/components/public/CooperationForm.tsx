...
export function CooperationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">שיתוף פעולה</h3>
      ...
      <div>
        <label htmlFor="coop-name" className="block text-sm font-medium text-gray-700 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="coop-phone" className="block text-sm font-medium text-gray-700 mb-2">
        ...
        <div>
          <label htmlFor="coop-email" className="block text-sm font-medium text-gray-700 mb-2">
            אימייל
          </label>
          <input
            type="email"
      ...
      <div>
        <label htmlFor="coop-message" className="block text-sm font-medium text-gray-700 mb-2">
          הצעה / פרטים
        </label>
        <textarea
          id="coop-message"
